...
public class ResultSentenceTypeImpl implements extensionTools.opl2.generated.ResultSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _ResultClause;
...
//        return (extensionTools.opl2.generated.ResultSentenceType.class);
//    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getResultClause() {
        if (this._ResultClause == null) {
            this._ResultClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._ResultClause;
    }

    public java.util.List getResultClause() {
        return this._getResultClause();
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.ResultSentenceTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((this._ResultClause == null)? 0 :this._ResultClause.size());
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (this._ResultClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ResultClause.get(idx2 ++)), "ResultClause");
            } else {
                context.startElement("", "ResultClause");
                int idx_6 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ResultClause.get(idx_6 ++)), "ResultClause");
                context.endNamespaceDecls();
                int idx_7 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ResultClause.get(idx_7 ++)), "ResultClause");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ResultClause.get(idx2 ++)), "ResultClause");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._ResultClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ResultClause.get(idx2 ++)), "ResultClause");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._ResultClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ResultClause.get(idx2 ++)), "ResultClause");
            } else {
                idx2 += 1;
            }
        }
...
+"\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000*extensionTools.opl2.generated.ResultC"
+"lauseq\u0000~\u0000Isq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq\u0000~"
+"\u0000$q\u0000~\u0000\'pq\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000.extensionTools.opl2.generate"
+"d.ResultClauseTypeq\u0000~\u0000Isq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq"
+"\u0000~\u0000/t\u0000\fResultClauseq\u0000~\u00009sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq\u0000~\u0000\tq\u0000~\u0000\'p\u0000sq\u0000"
+"~\u0000\u0000ppq\u0000~\u0000\u0011sq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\tPathLa"
+"belq\u0000~\u00009q\u0000~\u00005sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002"
...
+"r/ExpressionPool;xp\u0000\u0000\u0000\u001e\u0001pq\u0000~\u0000Vq\u0000~\u0000>q\u0000~\u0000^q\u0000~\u0000#q\u0000~\u0000Rq\u0000~\u0000Yq\u0000~\u0000m"
+"q\u0000~\u0000uq\u0000~\u0000rq\u0000~\u0000\u0005q\u0000~\u0000\u0006q\u0000~\u0000qq\u0000~\u0000Kq\u0000~\u0000fq\u0000~\u0000:q\u0000~\u0000\rq\u0000~\u0000Xq\u0000~\u0000\u0007q\u0000~\u0000t"
+"q\u0000~\u0000\bq\u0000~\u0000=q\u0000~\u0000]q\u0000~\u0000Aq\u0000~\u0000Nq\u0000~\u0000aq\u0000~\u0000iq\u0000~\u0000@q\u0000~\u0000Mq\u0000~\u0000`q\u0000~\u0000hx"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.ResultSentenceTypeImpl.this;
        }
                ...
                switch (this.state) {
                    ...
                    case  4 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            ResultSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                    ...
                    case  13 :
                        ...
                        return ;
                    case  10 :
                        if (("ResultClause" == ___local)&&("" == ___uri)) {
                            ResultSentenceTypeImpl.this._getResultClause().add(((extensionTools.opl2.generated.impl.ResultClauseImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ResultClauseImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ResultClause" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (this.state) {
                    case  8 :
                        if (("logicalRelation" == ___local)&&("" == ___uri)) {
                            ResultSentenceTypeImpl.this._getResultClause().add(((extensionTools.opl2.generated.impl.ResultClauseTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ResultClauseTypeImpl.class), 9, ___uri, ___local, ___qname)));
                            return ;
                        }
                    ...
                    case  14 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            ResultSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 15, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                ResultSentenceTypeImpl.this._getPathLabel().add(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                ResultSentenceTypeImpl.this._LogicalRelation = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                ResultSentenceTypeImpl.this._ProcessName = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
