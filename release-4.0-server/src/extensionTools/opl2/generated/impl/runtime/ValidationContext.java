...
//
    ...
    public void validate( ValidatableObject vo ) throws SAXException {
        if( this.validatedObjects.add(ProxyGroup.unwrap(vo)) ) {
            ...
            this.reportEvent( vo, Messages.format( Messages.CYCLE_DETECTED ) );
        }
    }
...
//
    ...
    public NamespaceContextImpl getNamespaceContext() { return this.nsContext; }
...
//
    ...
    public String onID( XMLSerializable owner, String value ) throws SAXException {
        ...
        if(!this.IDs.add(value)) {
            ...
            this.reportEvent(this.jaxbContext.getGrammarInfo().castToValidatableObject(owner),
                Messages.format(Messages.DUPLICATE_ID,value));
        }
    ...
    protected void reconcileIDs() throws SAXException {
        ...
        for (Iterator itr = this.IDREFs.entrySet().iterator(); itr.hasNext();) {
