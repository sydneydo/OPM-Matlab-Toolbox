...
class GrammarInfoFacade implements GrammarInfo {
	...
	public UnmarshallingEventHandler createUnmarshaller(String namespaceUri,
		...
		for (int i = 0; i < this.grammarInfos.length; i++) {
			UnmarshallingEventHandler ueh = this.grammarInfos[i].createUnmarshaller(
	...
	public com.sun.msv.grammar.Grammar getGrammar() throws JAXBException {
		if (this.bgm == null) {
			com.sun.msv.grammar.Grammar[] grammars = new com.sun.msv.grammar.Grammar[this.grammarInfos.length];
