...
public class ErrorHandlerAdaptor implements ErrorHandler {
    ...
    public void error(SAXParseException exception) 
        ...
        this.propagateEvent( ValidationEvent.ERROR, exception );
    }
    
    public void warning(SAXParseException exception) 
        throws SAXException {
            
        this.propagateEvent( ValidationEvent.WARNING, exception );
    }
    
    public void fatalError(SAXParseException exception) 
        throws SAXException {
            
        this.propagateEvent( ValidationEvent.FATAL_ERROR, exception );
    }
    ...
    private void propagateEvent( int severity, SAXParseException saxException ) 
        ...
        ValidationEventLocator vel = 
            this.locator.getLocation( saxException );
        ...
        this.host.handleEvent( ve, severity!=ValidationEvent.FATAL_ERROR );
    }
}
