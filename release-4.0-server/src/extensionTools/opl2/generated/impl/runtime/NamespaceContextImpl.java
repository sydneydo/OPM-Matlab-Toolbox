...
public class NamespaceContextImpl implements NamespaceContext2
{
    ...
    public NamespaceContextImpl(NamespacePrefixMapper _prefixMapper) {
        ...
        this.nss.declarePrefix( "xmlns", XMLConstants.XMLNS_ATTRIBUTE_NS_URI );
...
//
    ...
    public String declareNamespace( String namespaceUri, String preferedPrefix, boolean requirePrefix ) {
        if( !this.inCollectingMode ) {
            ...
            String prefix = (String)this.reverseDecls.get(namespaceUri);
            if( prefix!=null ) {
            ...
            if( namespaceUri.length()==0 ) {
                ...
                if( prefix==null ) {
					prefix = (String)this.reverseDecls.get(namespaceUri);
				}
                ...
                if( prefix==null ) {
                    ...
                    if( this.prefixMapper!=null ) {
						prefix = this.prefixMapper.getPreferredPrefix(
            ...
            while(true) {
                String existingUri = (String)this.decls.get(prefix);
    ...
    public String getNamespaceURI( String prefix ) {
        String uri = (String)this.decls.get(prefix);
        if(uri!=null) {
			return uri;
		}
    ...
    public Iterator getPrefixes( String namespaceUri ) {
        ...
        for( Enumeration e=this.nss.getPrefixes(namespaceUri); e.hasMoreElements(); ) {
			s.add(e.nextElement());
		}
    ...
    public void endNamespaceDecls() {
        if(!this.decls.isEmpty()) {
            ...
            for( Iterator itr=this.decls.entrySet().iterator(); itr.hasNext(); ) {
    ...
    public void iterateDeclaredPrefixes( PrefixCallback callback ) throws SAXException {
        for( Enumeration e=this.nss.getDeclaredPrefixes(); e.hasMoreElements(); ) {
            String p = (String)e.nextElement();
            String uri = this.nss.getURI(p);
