...
public class MSVValidator implements XMLSerializer, IDContextProvider2
{
    ...
    private void _validate() throws SAXException {
        ...
        if(!this.acceptor.isAcceptState(null)) {
    ...
    public void endAttributes() throws SAXException {
        if(!this.acceptor.onEndAttributes( null, null )) {
            ...
            StartTagInfo sti = new StartTagInfo(
                this.currentElementUri,this.currentElementLocalName,this.currentElementLocalName,
    ...
    public void reportMissingObjectError(String fieldName) throws SAXException {
        this.reportError(Util.createMissingObjectError(this.target,fieldName));
    }
    ...
    public void endAttribute() throws SAXException {
        ...
        if(!this.acceptor.onAttribute2( this.attNamespaceUri, this.attLocalName,
            this.attLocalName,
            this.buf.toString(),
            this, null, null )) {
            ...
            // report an error
            StringRef ref = new StringRef();
            this.acceptor.onAttribute2( this.attNamespaceUri, this.attLocalName, this.attLocalName,
            this.buf.toString(), this, ref, null );
    ...
    private void writePendingText() throws SAXException {
        // assert(textBuf!=null);
        if(!this.acceptor.onText2( this.buf.toString(), this, null, null )) {
            // this text is invalid.
            // report an error
            StringRef ref = new StringRef();
            this.acceptor.onText2( this.buf.toString(), this, ref, null );
            this.context.reportEvent(this.target,ref.str);
        }
    ...
    public void startElement( String uri, String local ) throws SAXException {
        ...
        Acceptor child = this.acceptor.createChildAcceptor( sti, null );
        if( child==null ) {
    ...
    public void endElement() throws SAXException {
        ...
        // pop the acceptor
        Acceptor child = this.acceptor;
        this.acceptor = (Acceptor)this.stack.pop();
        if(!this.acceptor.stepForward( child, null )) {
            // some required elements are missing.
            // report an error
            StringRef ref = new StringRef();
            this.acceptor.stepForward( child, ref );  // force recovery and obtain an error message.
...
//            atts = emptyAttributes;
        ...
        if(o instanceof RIElement) {
            ...
            if(!child.onAttribute2(
                ...
                this.context.reportEvent(this.target,
...
//
    public String onID( IdentifiableObject owner, String value ) throws SAXException {
        return this.context.onID(this.target,value);
    }
    public String onIDREF( IdentifiableObject value ) throws SAXException {
        return this.context.onIDREF(this.target,value.____jaxb____getId());
    }
