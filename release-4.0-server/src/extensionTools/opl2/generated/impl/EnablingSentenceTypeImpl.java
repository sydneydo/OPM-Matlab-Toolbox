...
public class EnablingSentenceTypeImpl implements extensionTools.opl2.generated.EnablingSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _EnablingClause;
    ...
    protected com.sun.xml.bind.util.ListImpl _getEnablingClause() {
        if (this._EnablingClause == null) {
            this._EnablingClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._EnablingClause;
    }

    public java.util.List getEnablingClause() {
        return this._getEnablingClause();
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.EnablingSentenceTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((this._EnablingClause == null)? 0 :this._EnablingClause.size());
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (this._EnablingClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._EnablingClause.get(idx2 ++)), "EnablingClause");
            } else {
                context.startElement("", "EnablingClause");
                int idx_6 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._EnablingClause.get(idx_6 ++)), "EnablingClause");
                context.endNamespaceDecls();
                int idx_7 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._EnablingClause.get(idx_7 ++)), "EnablingClause");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._EnablingClause.get(idx2 ++)), "EnablingClause");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._EnablingClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._EnablingClause.get(idx2 ++)), "EnablingClause");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._EnablingClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._EnablingClause.get(idx2 ++)), "EnablingClause");
            } else {
                idx2 += 1;
            }
        }
    ...
    public java.lang.Class getPrimaryInterface() {
        return (extensionTools.opl2.generated.EnablingSentenceType.class);
    }
...
+"\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000,extensionTools.opl2.generated.Enablin"
+"gClauseq\u0000~\u0000Isq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq"
+"\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u00000extensionTools.opl2.genera"
+"ted.EnablingClauseTypeq\u0000~\u0000Isq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~"
+"\u00005sq\u0000~\u0000/t\u0000\u000eEnablingClauseq\u0000~\u00009sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq\u0000~\u0000\tq\u0000~\u0000"
...
+"hx"));
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.EnablingSentenceTypeImpl.this;
        }
                ...
                switch (this.state) {
                    case  7 :
                        if (("EnablingClause" == ___local)&&("" == ___uri)) {
                            EnablingSentenceTypeImpl.this._getEnablingClause().add(((extensionTools.opl2.generated.impl.EnablingClauseImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.EnablingClauseImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("EnablingClause" == ___local)&&("" == ___uri)) {
                    ...
                    case  3 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            EnablingSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                ...
                switch (this.state) {
                    case  14 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            EnablingSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 15, ___uri, ___local, ___qname)));
                            return ;
                        }
                    ...
                    case  8 :
                        if (("logicalRelation" == ___local)&&("" == ___uri)) {
                            EnablingSentenceTypeImpl.this._getEnablingClause().add(((extensionTools.opl2.generated.impl.EnablingClauseTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.EnablingClauseTypeImpl.class), 9, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                EnablingSentenceTypeImpl.this._ProcessName = value;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                EnablingSentenceTypeImpl.this._getPathLabel().add(value);
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                EnablingSentenceTypeImpl.this._LogicalRelation = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
