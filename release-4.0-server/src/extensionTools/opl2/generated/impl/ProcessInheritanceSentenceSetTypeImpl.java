...
public class ProcessInheritanceSentenceSetTypeImpl implements extensionTools.opl2.generated.ProcessInheritanceSentenceSetType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _ProcessInheritanceSentence;
...
//        return (extensionTools.opl2.generated.ProcessInheritanceSentenceSetType.class);
//    }

    protected com.sun.xml.bind.util.ListImpl _getProcessInheritanceSentence() {
        if (this._ProcessInheritanceSentence == null) {
            this._ProcessInheritanceSentence = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._ProcessInheritanceSentence;
    }

    public java.util.List getProcessInheritanceSentence() {
        return this._getProcessInheritanceSentence();
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.ProcessInheritanceSentenceSetTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((this._ProcessInheritanceSentence == null)? 0 :this._ProcessInheritanceSentence.size());
        int idx2 = 0;
        ...
        while (idx1 != len1) {
            if (this._ProcessInheritanceSentence.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ProcessInheritanceSentence.get(idx1 ++)), "ProcessInheritanceSentence");
            } else {
                context.startElement("", "ProcessInheritanceSentence");
                int idx_4 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ProcessInheritanceSentence.get(idx_4 ++)), "ProcessInheritanceSentence");
                context.endNamespaceDecls();
                int idx_5 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ProcessInheritanceSentence.get(idx_5 ++)), "ProcessInheritanceSentence");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ProcessInheritanceSentence.get(idx1 ++)), "ProcessInheritanceSentence");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (this._ProcessInheritanceSentence.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ProcessInheritanceSentence.get(idx1 ++)), "ProcessInheritanceSentence");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (this._ProcessInheritanceSentence.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ProcessInheritanceSentence.get(idx1 ++)), "ProcessInheritanceSentence");
            } else {
                idx1 += 1;
            }
        }
...
+"9q\u0000~\u0000%psq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000Bq\u0000~\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u00008extensionTools.op"
+"l2.generated.ProcessInheritanceSentenceq\u0000~\u0000Gsq\u0000~\u0000\u0007q\u0000~\u0000%p\u0000sq\u0000"
+"~\u0000\u0000ppsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000Bq\u0000~\u0000Dq\u0000~\u0000"
+"3sq\u0000~\u0000-t\u0000<extensionTools.opl2.generated.ProcessInheritanceSe"
+"ntenceTypeq\u0000~\u0000Gsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u001aP"
+"rocessInheritanceSentenceq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.grammar.E"
...
+"t\u0000$Lcom/sun/msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0016\u0001pq\u0000~\u0000<q\u0000~\u0000Vq\u0000~"
+"\u0000!q\u0000~\u0000Pq\u0000~\u0000eq\u0000~\u0000Iq\u0000~\u0000^q\u0000~\u00008q\u0000~\u0000Tq\u0000~\u0000\u000bq\u0000~\u0000\u0006q\u0000~\u0000;q\u0000~\u0000Uq\u0000~\u0000?q\u0000~"
+"\u0000Lq\u0000~\u0000Yq\u0000~\u0000aq\u0000~\u0000>q\u0000~\u0000Kq\u0000~\u0000Xq\u0000~\u0000`q\u0000~\u0000\u0005x"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.ProcessInheritanceSentenceSetTypeImpl.this;
        }
                ...
                switch (this.state) {
                    ...
                    case  8 :
                        if (("InheritanceFatherName" == ___local)&&("" == ___uri)) {
                            ProcessInheritanceSentenceSetTypeImpl.this._getProcessInheritanceSentence().add(((extensionTools.opl2.generated.impl.ProcessInheritanceSentenceTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessInheritanceSentenceTypeImpl.class), 9, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  6 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            ProcessInheritanceSentenceSetTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                        ...
                        if (("ProcessInheritanceSentence" == ___local)&&("" == ___uri)) {
                            ProcessInheritanceSentenceSetTypeImpl.this._getProcessInheritanceSentence().add(((extensionTools.opl2.generated.impl.ProcessInheritanceSentenceImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessInheritanceSentenceImpl.class), 7, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ProcessInheritanceSentence" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                ...
                switch (this.state) {
                    case  4 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            ProcessInheritanceSentenceSetTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                ProcessInheritanceSentenceSetTypeImpl.this._ObjectName = value;
            } catch (java.lang.Exception e) {
