...
public class ObjectEnvironmentalPhysicalSentenceTypeImpl implements extensionTools.opl2.generated.ObjectEnvironmentalPhysicalSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{
    ...
    {
        if (!this.has_Transient) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "Transient"));
        }
        if (!this.has_Environmental) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "Environmental"));
        }
        int idx3 = 0;
        final int len3 = ((this._Role == null)? 0 :this._Role.size());
        if (!this.has_Physical) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "Physical"));
        }
        ...
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) this._Environmental)), "Environmental");
        } catch (java.lang.Exception e) {
            extensionTools.opl2.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) this._Physical)), "Physical");
        } catch (java.lang.Exception e) {
            extensionTools.opl2.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        ...
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) this._Transient)), "Transient");
        } catch (java.lang.Exception e) {
            extensionTools.opl2.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"q\u0000~\u0000&\u0001psq\u0000~\u0000/t\u0000\nObjectNamet\u0000\u0000sq\u0000~\u0000\"ppsr\u0000 com.sun.msv.grammar"
+".OneOrMoreExp\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xr\u0000\u001ccom.sun.msv.grammar.UnaryExp\u0000\u0000\u0000\u0000"
+"\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000\u0003expq\u0000~\u0000\u0002xq\u0000~\u0000\u0003q\u0000~\u0000\'psq\u0000~\u0000\"q\u0000~\u0000\'psq\u0000~\u0000\tq\u0000~\u0000\'p\u0000sq\u0000~\u0000"
+"\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq\u0000~\u0000$q\u0000~\u0000\'psr\u00002com.sun.msv.grammar.Expressio"
+"n$AnyStringExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00006psr\u0000 com.sun.msv."
+"grammar.AnyNameClass\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u00000q\u0000~\u00005sq\u0000~\u0000/t\u0000\"extension"
+"Tools.opl2.generated.Rolet\u0000+http://java.sun.com/jaxb/xjc/dum"
+"my-elementssq\u0000~\u0000\tq\u0000~\u0000\'p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'"
+"psq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000&extensionTools.opl2.gen"
+"erated.RoleTypeq\u0000~\u0000Isq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000"
+"/t\u0000\u0004Roleq\u0000~\u00009q\u0000~\u00005sq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u000eppsr\u0000$com.sun.msv.d"
+"atatype.xsd.BooleanType\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0013q\u0000~\u0000\u0019t\u0000\u0007booleanq\u0000~\u0000-"
+"q\u0000~\u0000\u001fsq\u0000~\u0000 q\u0000~\u0000[q\u0000~\u0000\u0019sq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~"
+"\u0000/t\u0000\rEnvironmentalq\u0000~\u00009sq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000Xsq\u0000~\u0000\"ppsq\u0000~\u0000$q"
+"\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\bPhysicalq\u0000~\u00009sq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppq"
+"\u0000~\u0000Xsq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\tTransientq\u0000~"
...
+"nPool;xp\u0000\u0000\u0000\u0015\u0001pq\u0000~\u0000>q\u0000~\u0000#q\u0000~\u0000Rq\u0000~\u0000]q\u0000~\u0000cq\u0000~\u0000iq\u0000~\u0000Wq\u0000~\u0000bq\u0000~\u0000hq"
+"\u0000~\u0000\u0005q\u0000~\u0000Kq\u0000~\u0000:q\u0000~\u0000\rq\u0000~\u0000\bq\u0000~\u0000\u0006q\u0000~\u0000=q\u0000~\u0000Aq\u0000~\u0000Nq\u0000~\u0000\u0007q\u0000~\u0000@q\u0000~\u0000Mx"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (this.state) {
                    ...
                    case  3 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            ObjectEnvironmentalPhysicalSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                    ...
                    case  4 :
                        ...
                        if (("Environmental" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, true);
                            this.state = 5;
                            return ;
                        }
                ...
                switch (this.state) {
                    case  14 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            ObjectEnvironmentalPhysicalSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 15, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this._Physical = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this.has_Physical = true;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this._ObjectName = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this._Transient = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this.has_Transient = true;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this._Environmental = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                ObjectEnvironmentalPhysicalSentenceTypeImpl.this.has_Environmental = true;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
