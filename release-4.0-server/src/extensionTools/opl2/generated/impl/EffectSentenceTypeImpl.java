...
public class EffectSentenceTypeImpl implements extensionTools.opl2.generated.EffectSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _EffectClause;
    ...
    protected com.sun.xml.bind.util.ListImpl _getEffectClause() {
        if (this._EffectClause == null) {
            this._EffectClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._EffectClause;
    }

    public java.util.List getEffectClause() {
        return this._getEffectClause();
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((this._EffectClause == null)? 0 :this._EffectClause.size());
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (this._EffectClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._EffectClause.get(idx2 ++)), "EffectClause");
            } else {
                context.startElement("", "EffectClause");
                int idx_6 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._EffectClause.get(idx_6 ++)), "EffectClause");
                context.endNamespaceDecls();
                int idx_7 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._EffectClause.get(idx_7 ++)), "EffectClause");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._EffectClause.get(idx2 ++)), "EffectClause");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._EffectClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._EffectClause.get(idx2 ++)), "EffectClause");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._EffectClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._EffectClause.get(idx2 ++)), "EffectClause");
            } else {
                idx2 += 1;
            }
        }
...
+"\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000*extensionTools.opl2.generated.EffectC"
+"lauseq\u0000~\u0000Isq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq\u0000~"
+"\u0000$q\u0000~\u0000\'pq\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000.extensionTools.opl2.generate"
+"d.EffectClauseTypeq\u0000~\u0000Isq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq"
+"\u0000~\u0000/t\u0000\fEffectClauseq\u0000~\u00009sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'psq\u0000~\u0000\tq\u0000~\u0000\'p\u0000sq\u0000"
...
+"q\u0000~\u0000\bq\u0000~\u0000=q\u0000~\u0000]q\u0000~\u0000Aq\u0000~\u0000Nq\u0000~\u0000aq\u0000~\u0000iq\u0000~\u0000@q\u0000~\u0000Mq\u0000~\u0000`q\u0000~\u0000hx"));
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (this.state) {
                    ...
                    case  4 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            EffectSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                    ...
                    case  8 :
                        if (("EffectClause" == ___local)&&("" == ___uri)) {
                            EffectSentenceTypeImpl.this._getEffectClause().add(((extensionTools.opl2.generated.impl.EffectClauseImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.EffectClauseImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("EffectClause" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                ...
                switch (this.state) {
                    case  14 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            EffectSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 15, ___uri, ___local, ___qname)));
                            return ;
                        }
                    ...
                    case  9 :
                        if (("logicalRelation" == ___local)&&("" == ___uri)) {
                            EffectSentenceTypeImpl.this._getEffectClause().add(((extensionTools.opl2.generated.impl.EffectClauseTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.EffectClauseTypeImpl.class), 10, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                EffectSentenceTypeImpl.this._ProcessName = value;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                EffectSentenceTypeImpl.this._LogicalRelation = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                EffectSentenceTypeImpl.this._getPathLabel().add(value);
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
