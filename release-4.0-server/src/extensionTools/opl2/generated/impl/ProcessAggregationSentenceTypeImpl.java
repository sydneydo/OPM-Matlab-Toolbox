...
//        return (extensionTools.opl2.generated.ProcessAggregationSentenceType.class);
//    }
    ...
    protected com.sun.xml.bind.util.ListImpl _getAggregatedProcess() {
        if (this._AggregatedProcess == null) {
            this._AggregatedProcess = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._AggregatedProcess;
    }

    public java.util.List getAggregatedProcess() {
        return this._getAggregatedProcess();
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.ProcessAggregationSentenceTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((this._AggregatedProcess == null)? 0 :this._AggregatedProcess.size());
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            context.startElement("", "AggregatedProcess");
            int idx_4 = idx2;
            try {
                idx_4 += 1;
            } catch (java.lang.Exception e) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) this._AggregatedProcess.get(idx2 ++)), "AggregatedProcess");
            } catch (java.lang.Exception e) {
                extensionTools.opl2.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"~\u0000\u0002xq\u0000~\u0000\u0003q\u0000~\u0000%psq\u0000~\u0000 q\u0000~\u0000%psq\u0000~\u0000\u0007q\u0000~\u0000%p\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%p"
+"sq\u0000~\u0000\"q\u0000~\u0000%psr\u00002com.sun.msv.grammar.Expression$AnyStringExpr"
+"ession\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003q\u0000~\u00004psr\u0000 com.sun.msv.grammar.AnyName"
+"Class\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000.q\u0000~\u00003sq\u0000~\u0000-t\u0000\"extensionTools.opl2.gene"
+"rated.Rolet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~"
+"\u0000\u0007q\u0000~\u0000%p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~\u0000\"q\u0000~\u0000%pq\u0000"
+"~\u0000Bq\u0000~\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u0000&extensionTools.opl2.generated.RoleType"
+"q\u0000~\u0000Gsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u0004Roleq\u0000~\u00007q\u0000"
+"~\u00003sq\u0000~\u00009ppsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u000fsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000"
+"~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u0011AggregatedProcessq\u0000~\u00007sr\u0000\"com.sun.msv.gramm"
...
+"!q\u0000~\u0000Pq\u0000~\u0000Wq\u0000~\u0000Tq\u0000~\u0000Iq\u0000~\u00008q\u0000~\u0000\u000bq\u0000~\u0000Vq\u0000~\u0000\u0006q\u0000~\u0000;q\u0000~\u0000?q\u0000~\u0000Lq\u0000~\u0000"
+"\u0005q\u0000~\u0000>q\u0000~\u0000Kx"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.ProcessAggregationSentenceTypeImpl.this;
        }
                ...
                switch (this.state) {
                    case  3 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            ProcessAggregationSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                        ...
                        continue outer;
                    case  9 :
                        if (("AggregatedProcess" == ___local)&&("" == ___uri)) {
                ...
                switch (this.state) {
                    ...
                    case  4 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            ProcessAggregationSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                ProcessAggregationSentenceTypeImpl.this._ProcessName = value;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                ProcessAggregationSentenceTypeImpl.this._getAggregatedProcess().add(value);
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
