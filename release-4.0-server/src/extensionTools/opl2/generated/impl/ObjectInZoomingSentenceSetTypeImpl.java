...
public class ObjectInZoomingSentenceSetTypeImpl implements extensionTools.opl2.generated.ObjectInZoomingSentenceSetType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected extensionTools.opl2.generated.ObjectInZoomingSentenceType _ObjectInZoomingSentence;
    ...
    public extensionTools.opl2.generated.ObjectInZoomingSentenceType getObjectInZoomingSentence() {
        return this._ObjectInZoomingSentence;
    }

    public void setObjectInZoomingSentence(extensionTools.opl2.generated.ObjectInZoomingSentenceType value) {
        this._ObjectInZoomingSentence = value;
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.ObjectInZoomingSentenceSetTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (this._ObjectInZoomingSentence instanceof javax.xml.bind.Element) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ObjectInZoomingSentence), "ObjectInZoomingSentence");
        } else {
            context.startElement("", "ObjectInZoomingSentence");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ObjectInZoomingSentence), "ObjectInZoomingSentence");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ObjectInZoomingSentence), "ObjectInZoomingSentence");
    ...
    public java.lang.Class getPrimaryInterface() {
        return (extensionTools.opl2.generated.ObjectInZoomingSentenceSetType.class);
    }
...
+"ang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001dxq\u0000~\u0000\u0018t\u00005extensionTools.opl2."
+"generated.ObjectInZoomingSentencet\u0000+http://java.sun.com/jaxb"
+"/xjc/dummy-elementssq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\rq"
+"\u0000~\u0000\u0011psq\u0000~\u0000\u0012q\u0000~\u0000\u0011pq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u00009extensionTools.opl2"
+".generated.ObjectInZoomingSentenceTypeq\u0000~\u0000 sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0012q\u0000~"
...
+"instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0017ObjectInZoomingSentencet\u0000\u0000sq\u0000~\u0000\u0006ppsq\u0000~"
+"\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0006q\u0000~\u0000\u0011psq\u0000~\u0000\bq\u0000~\u0000\u0011p\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012q"
+"\u0000~\u0000\u0011pq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000.extensionTools.opl2.generated.T"
+"hingSentenceSetq\u0000~\u0000 sq\u0000~\u0000\bq\u0000~\u0000\u0011p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0006ppsq"
+"\u0000~\u0000\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012q\u0000~\u0000\u0011pq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u00002extensionTools"
+".opl2.generated.ThingSentenceSetTypeq\u0000~\u0000 sq\u0000~\u0000\u0006ppsq\u0000~\u0000\u0012q\u0000~\u0000\u0011"
+"pq\u0000~\u0000.q\u0000~\u0000>q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0010ThingSentenceSetq\u0000~\u0000Cq\u0000~\u0000\u001bsr\u0000\"com.s"
...
+"~\u0000Iq\u0000~\u0000Qq\u0000~\u0000\fq\u0000~\u0000$q\u0000~\u0000Hq\u0000~\u0000Px"));
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.ObjectInZoomingSentenceSetTypeImpl.this;
        }
                ...
                switch (this.state) {
                    ...
                    case  0 :
                        if (("ObjectInZoomingSentence" == ___local)&&("" == ___uri)) {
                            ObjectInZoomingSentenceSetTypeImpl.this._ObjectInZoomingSentence = ((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceImpl.class), 1, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("ObjectInZoomingSentence" == ___local)&&("" == ___uri)) {
                    ...
                    case  4 :
                        if (("ThingSentenceSet" == ___local)&&("" == ___uri)) {
                            ObjectInZoomingSentenceSetTypeImpl.this._getThingSentenceSet().add(((extensionTools.opl2.generated.impl.ThingSentenceSetImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ThingSentenceSetImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ThingSentenceSet" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                    ...
                    case  5 :
                        if (("ObjectName" == ___local)&&("" == ___uri)) {
                            ObjectInZoomingSentenceSetTypeImpl.this._ObjectInZoomingSentence = ((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceTypeImpl.class), 6, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  1 :
                ...
                switch (this.state) {
                    case  2 :
                        if (("subjectAggregationFatherName" == ___local)&&("" == ___uri)) {
                            ObjectInZoomingSentenceSetTypeImpl.this._getThingSentenceSet().add(((extensionTools.opl2.generated.impl.ThingSentenceSetTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ThingSentenceSetTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
