...
public class DestinationRoleTypeImpl implements extensionTools.opl2.generated.DestinationRoleType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{
                ...
                switch (this.state) {
                    case  1 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            DestinationRoleTypeImpl.this._getRole().add((this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 1, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                ...
                switch (this.state) {
                    ...
                    case  2 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            DestinationRoleTypeImpl.this._getRole().add((this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 3, ___uri, ___local, ___qname)));
                            return ;
                        }
