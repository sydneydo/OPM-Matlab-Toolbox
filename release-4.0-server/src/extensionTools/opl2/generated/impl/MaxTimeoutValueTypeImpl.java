...
public class MaxTimeoutValueTypeImpl implements extensionTools.opl2.generated.MaxTimeoutValueType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.MaxTimeoutValueTypeImpl.Unmarshaller(context);
    }
    ...
    public java.lang.Class getPrimaryInterface() {
        return (extensionTools.opl2.generated.MaxTimeoutValueType.class);
    }
...
+"l;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u0005q\u0000~\u0000(q\u0000~\u0000!q\u0000~\u0000\rq\u0000~\u0000$q\u0000~\u0000\nq\u0000~\u0000#x"));
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.MaxTimeoutValueTypeImpl.this;
        }
                ...
                switch (this.state) {
                    case  2 :
                        if (("Years" == ___local)&&("" == ___uri)) {
                            MaxTimeoutValueTypeImpl.this._TimeValue = ((extensionTools.opl2.generated.impl.TimeValueTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.TimeValueTypeImpl.class), 3, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                    ...
                    case  0 :
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
                            MaxTimeoutValueTypeImpl.this._TimeValue = ((extensionTools.opl2.generated.impl.TimeValueImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.TimeValueImpl.class), 1, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (this.state) {
                    case  2 :
                        MaxTimeoutValueTypeImpl.this._TimeValue = ((extensionTools.opl2.generated.impl.TimeValueTypeImpl) this.spawnChildFromLeaveElement((extensionTools.opl2.generated.impl.TimeValueTypeImpl.class), 3, ___uri, ___local, ___qname));
                        return ;
                    case  3 :
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (this.state) {
                    case  2 :
                        MaxTimeoutValueTypeImpl.this._TimeValue = ((extensionTools.opl2.generated.impl.TimeValueTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.TimeValueTypeImpl.class), 3, ___uri, ___local, ___qname));
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (this.state) {
                    case  2 :
                        MaxTimeoutValueTypeImpl.this._TimeValue = ((extensionTools.opl2.generated.impl.TimeValueTypeImpl) this.spawnChildFromLeaveAttribute((extensionTools.opl2.generated.impl.TimeValueTypeImpl.class), 3, ___uri, ___local, ___qname));
                        return ;
                    case  1 :
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (this.state) {
                        case  2 :
                            MaxTimeoutValueTypeImpl.this._TimeValue = ((extensionTools.opl2.generated.impl.TimeValueTypeImpl) this.spawnChildFromText((extensionTools.opl2.generated.impl.TimeValueTypeImpl.class), 3, value));
                            return ;
                        case  1 :
