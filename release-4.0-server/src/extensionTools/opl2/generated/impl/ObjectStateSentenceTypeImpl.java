...
public class ObjectStateSentenceTypeImpl implements extensionTools.opl2.generated.ObjectStateSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _StateClause;
    ...
    protected com.sun.xml.bind.util.ListImpl _getStateClause() {
        if (this._StateClause == null) {
            this._StateClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._StateClause;
    }

    public java.util.List getStateClause() {
        return this._getStateClause();
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((this._StateClause == null)? 0 :this._StateClause.size());
        int idx2 = 0;
        ...
        while (idx1 != len1) {
            if (this._StateClause.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._StateClause.get(idx1 ++)), "StateClause");
            } else {
                context.startElement("", "StateClause");
                int idx_4 = idx1;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._StateClause.get(idx_4 ++)), "StateClause");
                context.endNamespaceDecls();
                int idx_5 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._StateClause.get(idx_5 ++)), "StateClause");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._StateClause.get(idx1 ++)), "StateClause");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (this._StateClause.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._StateClause.get(idx1 ++)), "StateClause");
            } else {
                idx1 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            if (this._StateClause.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._StateClause.get(idx1 ++)), "StateClause");
            } else {
                idx1 += 1;
            }
        }
...
+"\u0000~\u0000Bq\u0000~\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u0000)extensionTools.opl2.generated.StateCl"
+"auseq\u0000~\u0000Gsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~\u0000"
+"\"q\u0000~\u0000%pq\u0000~\u0000Bq\u0000~\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u0000-extensionTools.opl2.generated"
+".StateClauseTypeq\u0000~\u0000Gsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~"
+"\u0000-t\u0000\u000bStateClauseq\u0000~\u00007sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000"
...
+"v/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0015\u0001pq\u0000~\u0000<q\u0000~\u0000Uq\u0000~\u0000!q\u0000~\u0000Pq\u0000~\u0000dq\u0000"
+"~\u0000Iq\u0000~\u0000]q\u0000~\u00008q\u0000~\u0000\u0005q\u0000~\u0000\u000bq\u0000~\u0000\u0006q\u0000~\u0000;q\u0000~\u0000Tq\u0000~\u0000?q\u0000~\u0000Lq\u0000~\u0000Xq\u0000~\u0000`q\u0000"
+"~\u0000>q\u0000~\u0000Kq\u0000~\u0000Wq\u0000~\u0000_x"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (this.state) {
                    case  6 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            ObjectStateSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                        ...
                        if (("StateClause" == ___local)&&("" == ___uri)) {
                            ObjectStateSentenceTypeImpl.this._getStateClause().add(((extensionTools.opl2.generated.impl.StateClauseImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.StateClauseImpl.class), 9, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("StateClause" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                    ...
                    case  7 :
                        if (("StateName" == ___local)&&("" == ___uri)) {
                            ObjectStateSentenceTypeImpl.this._getStateClause().add(((extensionTools.opl2.generated.impl.StateClauseTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.StateClauseTypeImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :
                ...
                switch (this.state) {
                    case  4 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            ObjectStateSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                ObjectStateSentenceTypeImpl.this._ObjectName = value;
            } catch (java.lang.Exception e) {
