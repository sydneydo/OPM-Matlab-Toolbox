...
public class AgentSentenceTypeImpl implements extensionTools.opl2.generated.AgentSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected extensionTools.opl2.generated.MaxReactionTimeType _MaxReactionTime;
    protected com.sun.xml.bind.util.ListImpl _TriggeredProcessRole;
    ...
    protected com.sun.xml.bind.util.ListImpl _getTriggeredProcessRole() {
        if (this._TriggeredProcessRole == null) {
            this._TriggeredProcessRole = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._TriggeredProcessRole;
    }

    public java.util.List getTriggeredProcessRole() {
        return this._getTriggeredProcessRole();
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((this._TriggeredProcessRole == null)? 0 :this._TriggeredProcessRole.size());
        int idx4 = 0;
        ...
        while (idx2 != len2) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) this._TriggeredProcessRole.get(idx2 ++)), "TriggeredProcessRole");
            } catch (java.lang.Exception e) {
                extensionTools.opl2.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
...
+"\u0000~\u0000\u0014sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000+q\u0000~\u00004q\u0000~\u00008sq\u0000~\u00002t\u0000\u000fLogicalRelat"
+"ionq\u0000~\u0000<sq\u0000~\u0000>ppsq\u0000~\u0000\fpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0014sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000*pq\u0000"
+"~\u0000+q\u0000~\u00004q\u0000~\u00008sq\u0000~\u00002t\u0000\u0014TriggeredProcessNameq\u0000~\u0000<sq\u0000~\u0000>ppsq\u0000~\u0000"
+"\fpp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0014sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000+q\u0000~\u00004q\u0000~\u00008sq\u0000~\u00002t\u0000"
+"\u0014TriggeredProcessRoleq\u0000~\u0000<sq\u0000~\u0000%ppsq\u0000~\u0000>q\u0000~\u0000*psq\u0000~\u0000\fq\u0000~\u0000*p\u0000s"
+"q\u0000~\u0000\u0000ppq\u0000~\u0000\u0014sq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000+q\u0000~\u00004q\u0000~\u00008sq\u0000~\u00002t\u0000\tPath"
+"Labelq\u0000~\u0000<q\u0000~\u00008sq\u0000~\u0000%ppsq\u0000~\u0000%q\u0000~\u0000*psq\u0000~\u0000\fq\u0000~\u0000*p\u0000sq\u0000~\u0000%ppsq\u0000~"
+"\u0000>q\u0000~\u0000*psq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000Gq\u0000~\u0000Iq\u0000~\u00008sq\u0000~\u00002t\u0000-extensionTools.o"
+"pl2.generated.MinReactionTimeq\u0000~\u0000Lsq\u0000~\u0000\fq\u0000~\u0000*p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000"
+"\fpp\u0000sq\u0000~\u0000%ppsq\u0000~\u0000>q\u0000~\u0000*psq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000Gq\u0000~\u0000Iq\u0000~\u00008sq\u0000~\u00002t\u00001"
+"extensionTools.opl2.generated.MinReactionTimeTypeq\u0000~\u0000Lsq\u0000~\u0000%"
+"ppsq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000+q\u0000~\u00004q\u0000~\u00008sq\u0000~\u00002t\u0000\u000fMinReactionTimeq\u0000~\u0000<q\u0000"
+"~\u00008sq\u0000~\u0000%ppsq\u0000~\u0000%q\u0000~\u0000*psq\u0000~\u0000\fq\u0000~\u0000*p\u0000sq\u0000~\u0000%ppsq\u0000~\u0000>q\u0000~\u0000*psq\u0000~"
+"\u0000\'q\u0000~\u0000*pq\u0000~\u0000Gq\u0000~\u0000Iq\u0000~\u00008sq\u0000~\u00002t\u0000-extensionTools.opl2.generate"
+"d.MaxReactionTimeq\u0000~\u0000Lsq\u0000~\u0000\fq\u0000~\u0000*p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\fpp\u0000sq\u0000~\u0000%pp"
+"sq\u0000~\u0000>q\u0000~\u0000*psq\u0000~\u0000\'q\u0000~\u0000*pq\u0000~\u0000Gq\u0000~\u0000Iq\u0000~\u00008sq\u0000~\u00002t\u00001extensionToo"
+"ls.opl2.generated.MaxReactionTimeTypeq\u0000~\u0000Lsq\u0000~\u0000%ppsq\u0000~\u0000\'q\u0000~\u0000"
+"*pq\u0000~\u0000+q\u0000~\u00004q\u0000~\u00008sq\u0000~\u00002t\u0000\u000fMaxReactionTimeq\u0000~\u0000<q\u0000~\u00008sr\u0000\"com.s"
...
+".\u0001pq\u0000~\u0000Aq\u0000~\u0000vq\u0000~\u0000\u008aq\u0000~\u0000\nq\u0000~\u0000&q\u0000~\u0000Uq\u0000~\u0000[q\u0000~\u0000bq\u0000~\u0000_q\u0000~\u0000iq\u0000~\u0000fq\u0000"
+"~\u0000qq\u0000~\u0000nq\u0000~\u0000\u0085q\u0000~\u0000\u0099q\u0000~\u0000mq\u0000~\u0000\u0005q\u0000~\u0000Nq\u0000~\u0000~q\u0000~\u0000\u0092q\u0000~\u0000=q\u0000~\u0000\u0010q\u0000~\u0000Zq\u0000"
+"~\u0000aq\u0000~\u0000hq\u0000~\u0000pq\u0000~\u0000\u000bq\u0000~\u0000\u0006q\u0000~\u0000@q\u0000~\u0000Dq\u0000~\u0000Qq\u0000~\u0000yq\u0000~\u0000\u0081q\u0000~\u0000\u008dq\u0000~\u0000\u0095q\u0000"
+"~\u0000\u0007q\u0000~\u0000Cq\u0000~\u0000Pq\u0000~\u0000xq\u0000~\u0000\u0080q\u0000~\u0000\u008cq\u0000~\u0000\u0094q\u0000~\u0000\bq\u0000~\u0000uq\u0000~\u0000\u0089q\u0000~\u0000\tx"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (this.state) {
                    case  4 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                    ...
                    case  18 :
                        ...
                        if (("MinReactionTime" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._MinReactionTime = ((extensionTools.opl2.generated.impl.MinReactionTimeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MinReactionTimeImpl.class), 21, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("MinReactionTime" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                    ...
                    case  21 :
                        if (("MaxReactionTime" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._MaxReactionTime = ((extensionTools.opl2.generated.impl.MaxReactionTimeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MaxReactionTimeImpl.class), 22, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("MaxReactionTime" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                    ...
                    case  23 :
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._MaxReactionTime = ((extensionTools.opl2.generated.impl.MaxReactionTimeTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MaxReactionTimeTypeImpl.class), 24, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._MaxReactionTime = ((extensionTools.opl2.generated.impl.MaxReactionTimeTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MaxReactionTimeTypeImpl.class), 24, ___uri, ___local, ___qname, __atts));
                    ...
                    case  19 :
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._MinReactionTime = ((extensionTools.opl2.generated.impl.MinReactionTimeTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MinReactionTimeTypeImpl.class), 20, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("TimeValue" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._MinReactionTime = ((extensionTools.opl2.generated.impl.MinReactionTimeTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MinReactionTimeTypeImpl.class), 20, ___uri, ___local, ___qname, __atts));
                ...
                switch (this.state) {
                    ...
                    case  5 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            AgentSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 6, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                AgentSentenceTypeImpl.this._ObjectName = value;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                AgentSentenceTypeImpl.this._LogicalRelation = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                AgentSentenceTypeImpl.this._getPathLabel().add(value);
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                AgentSentenceTypeImpl.this._getTriggeredProcessName().add(value);
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                AgentSentenceTypeImpl.this._getTriggeredProcessRole().add(value);
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
