...
public class ProcessExhibitionSentenceSetTypeImpl implements extensionTools.opl2.generated.ProcessExhibitionSentenceSetType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected extensionTools.opl2.generated.ProcessExhibitionSentenceType _ProcessExhibitionSentence;
...
//        return (extensionTools.opl2.generated.ProcessExhibitionSentenceSetType.class);
//    }

    public extensionTools.opl2.generated.ProcessExhibitionSentenceType getProcessExhibitionSentence() {
        return this._ProcessExhibitionSentence;
    }

    public void setProcessExhibitionSentence(extensionTools.opl2.generated.ProcessExhibitionSentenceType value) {
        this._ProcessExhibitionSentence = value;
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.ProcessExhibitionSentenceSetTypeImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (this._ProcessExhibitionSentence instanceof javax.xml.bind.Element) {
            context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ProcessExhibitionSentence), "ProcessExhibitionSentence");
        } else {
            context.startElement("", "ProcessExhibitionSentence");
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ProcessExhibitionSentence), "ProcessExhibitionSentence");
            context.endNamespaceDecls();
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ProcessExhibitionSentence), "ProcessExhibitionSentence");
...
+"generated.ProcessExhibitionSentencet\u0000+http://java.sun.com/ja"
+"xb/xjc/dummy-elementssq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\bpp\u0000sq\u0000~\u0000\u0006ppsq\u0000~\u0000"
+"\rq\u0000~\u0000\u0011psq\u0000~\u0000\u0012q\u0000~\u0000\u0011pq\u0000~\u0000\u0015q\u0000~\u0000\u0019q\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000;extensionTools.op"
+"l2.generated.ProcessExhibitionSentenceTypeq\u0000~\u0000 sq\u0000~\u0000\u0006ppsq\u0000~\u0000"
...
+"ema-instanceq\u0000~\u0000\u001bsq\u0000~\u0000\u001ct\u0000\u0019ProcessExhibitionSentencet\u0000\u0000sq\u0000~\u0000\u0006"
...
+"\u0000~\u0000%q\u0000~\u0000Iq\u0000~\u0000Qq\u0000~\u0000\fq\u0000~\u0000$q\u0000~\u0000Hq\u0000~\u0000Px"));
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.ProcessExhibitionSentenceSetTypeImpl.this;
        }
                ...
                switch (this.state) {
                    ...
                    case  4 :
                        if (("ThingSentenceSet" == ___local)&&("" == ___uri)) {
                            ProcessExhibitionSentenceSetTypeImpl.this._getThingSentenceSet().add(((extensionTools.opl2.generated.impl.ThingSentenceSetImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ThingSentenceSetImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ThingSentenceSet" == ___local)&&("" == ___uri)) {
                    ...
                    case  1 :
                        if (("ProcessName" == ___local)&&("" == ___uri)) {
                            ProcessExhibitionSentenceSetTypeImpl.this._ProcessExhibitionSentence = ((extensionTools.opl2.generated.impl.ProcessExhibitionSentenceTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessExhibitionSentenceTypeImpl.class), 2, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        break;
                    case  0 :
                        if (("ProcessExhibitionSentence" == ___local)&&("" == ___uri)) {
                            ProcessExhibitionSentenceSetTypeImpl.this._ProcessExhibitionSentence = ((extensionTools.opl2.generated.impl.ProcessExhibitionSentenceImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessExhibitionSentenceImpl.class), 3, ___uri, ___local, ___qname, __atts));
                            return ;
                        }
                        if (("ProcessExhibitionSentence" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                ...
                switch (this.state) {
                    case  5 :
                        if (("subjectAggregationFatherName" == ___local)&&("" == ___uri)) {
                            ProcessExhibitionSentenceSetTypeImpl.this._getThingSentenceSet().add(((extensionTools.opl2.generated.impl.ThingSentenceSetTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ThingSentenceSetTypeImpl.class), 6, ___uri, ___local, ___qname)));
                            return ;
                        }
