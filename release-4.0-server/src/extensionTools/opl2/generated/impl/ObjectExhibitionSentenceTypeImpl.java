...
public class ObjectExhibitionSentenceTypeImpl implements extensionTools.opl2.generated.ObjectExhibitionSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx2 = 0;
        final int len2 = ((this._ExhibitedObject == null)? 0 :this._ExhibitedObject.size());
        ...
        context.endElement();
        while (idx2 != len2) {
            if (this._ExhibitedObject.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ExhibitedObject.get(idx2 ++)), "ExhibitedObject");
            } else {
                context.startElement("", "ExhibitedObject");
                int idx_2 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ExhibitedObject.get(idx_2 ++)), "ExhibitedObject");
                context.endNamespaceDecls();
                int idx_3 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ExhibitedObject.get(idx_3 ++)), "ExhibitedObject");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ExhibitedObject.get(idx2 ++)), "ExhibitedObject");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._ExhibitedObject.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ExhibitedObject.get(idx2 ++)), "ExhibitedObject");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._ExhibitedObject.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ExhibitedObject.get(idx2 ++)), "ExhibitedObject");
            } else {
                idx2 += 1;
            }
        }
...
+"ated.ExhibitedObjectt\u0000+http://java.sun.com/jaxb/xjc/dummy-el"
+"ementssq\u0000~\u0000\u0007q\u0000~\u0000%p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~"
+"\u0000\"q\u0000~\u0000%pq\u0000~\u0000Bq\u0000~\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u00001extensionTools.opl2.generate"
+"d.ExhibitedObjectTypeq\u0000~\u0000Gsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u0000"
+"3sq\u0000~\u0000-t\u0000\u000fExhibitedObjectq\u0000~\u00007q\u0000~\u00003sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~\u0000"
+" q\u0000~\u0000%psq\u0000~\u0000\u0007q\u0000~\u0000%p\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000Bq\u0000~"
+"\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u0000\'extensionTools.opl2.generated.Operationq\u0000~\u0000G"
+"sq\u0000~\u0000\u0007q\u0000~\u0000%p\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000 ppsq\u0000~\u00009q\u0000~\u0000%psq\u0000~\u0000\"q\u0000~\u0000"
+"%pq\u0000~\u0000Bq\u0000~\u0000Dq\u0000~\u00003sq\u0000~\u0000-t\u0000+extensionTools.opl2.generated.Oper"
+"ationTypeq\u0000~\u0000Gsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\tOp"
+"erationq\u0000~\u00007q\u0000~\u00003sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000"
...
+"ammar/ExpressionPool;xp\u0000\u0000\u0000\u0016\u0001pq\u0000~\u0000<q\u0000~\u0000Vq\u0000~\u0000!q\u0000~\u0000Pq\u0000~\u0000eq\u0000~\u0000Iq"
+"\u0000~\u0000^q\u0000~\u00008q\u0000~\u0000Tq\u0000~\u0000\u000bq\u0000~\u0000\u0006q\u0000~\u0000;q\u0000~\u0000Uq\u0000~\u0000?q\u0000~\u0000Lq\u0000~\u0000Yq\u0000~\u0000aq\u0000~\u0000>q"
+"\u0000~\u0000Kq\u0000~\u0000Xq\u0000~\u0000`q\u0000~\u0000\u0005x"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
                ...
                switch (this.state) {
                    case  7 :
                        if (("OperationName" == ___local)&&("" == ___uri)) {
                            ObjectExhibitionSentenceTypeImpl.this._getOperation().add(((extensionTools.opl2.generated.impl.OperationTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.OperationTypeImpl.class), 8, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  4 :
                        if (("ExhibitedObject" == ___local)&&("" == ___uri)) {
                            ObjectExhibitionSentenceTypeImpl.this._getExhibitedObject().add(((extensionTools.opl2.generated.impl.ExhibitedObjectImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ExhibitedObjectImpl.class), 4, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ExhibitedObject" == ___local)&&("" == ___uri)) {
                        ...
                        if (("Operation" == ___local)&&("" == ___uri)) {
                            ObjectExhibitionSentenceTypeImpl.this._getOperation().add(((extensionTools.opl2.generated.impl.OperationImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.OperationImpl.class), 9, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Operation" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
                    ...
                    case  5 :
                        if (("MinimalCardinality" == ___local)&&("" == ___uri)) {
                            ObjectExhibitionSentenceTypeImpl.this._getExhibitedObject().add(((extensionTools.opl2.generated.impl.ExhibitedObjectTypeImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ExhibitedObjectTypeImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                }
        ...
        {
            try {
                ObjectExhibitionSentenceTypeImpl.this._ObjectName = value;
            } catch (java.lang.Exception e) {
