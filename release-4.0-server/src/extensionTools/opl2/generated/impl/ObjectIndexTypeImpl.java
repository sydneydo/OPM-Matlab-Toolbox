...
public class ObjectIndexTypeImpl implements extensionTools.opl2.generated.ObjectIndexType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{
    ...
    public void setIndexLocation(int value) {
        this._IndexLocation = value;
        this.has_IndexLocation = true;
    }
    ...
    {
        if (!this.has_IndexLocation) {
            context.reportError(com.sun.xml.bind.serializer.Util.createMissingObjectError(this, "IndexLocation"));
        }
        context.startElement("", "IndexName");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text((this._IndexName), "IndexName");
        ...
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printInt((this._IndexLocation)), "IndexLocation");
        } catch (java.lang.Exception e) {
            extensionTools.opl2.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000#\u0001psq\u0000~\u0000,t\u0000\tIndexNam"
...
+"\u0000~\u0000$pq\u0000~\u0000%q\u0000~\u0000.q\u0000~\u00002sq\u0000~\u0000,t\u0000\rIndexLocationq\u0000~\u00006sr\u0000\"com.sun.m"
...
+"\u0000~\u0000 q\u0000~\u0000aq\u0000~\u0000\u0005q\u0000~\u0000\nq\u0000~\u00008x"));
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
            ...
            while (true) {
                switch (this.state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  3 :
                        if (("IndexLocation" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, true);
                            this.state = 4;
                            return ;
                        }
        ...
        {
            try {
                ObjectIndexTypeImpl.this._IndexLocation = javax.xml.bind.DatatypeConverter.parseInt(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                ObjectIndexTypeImpl.this.has_IndexLocation = true;
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                ObjectIndexTypeImpl.this._IndexName = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
