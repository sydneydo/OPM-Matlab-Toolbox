...
public class ConsumptionSentenceTypeImpl implements extensionTools.opl2.generated.ConsumptionSentenceType, com.sun.xml.bind.JAXBObject, extensionTools.opl2.generated.impl.runtime.UnmarshallableObject, extensionTools.opl2.generated.impl.runtime.XMLSerializable, extensionTools.opl2.generated.impl.runtime.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _ConsumptionClause;
    ...
    protected com.sun.xml.bind.util.ListImpl _getConsumptionClause() {
        if (this._ConsumptionClause == null) {
            this._ConsumptionClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return this._ConsumptionClause;
    }

    public java.util.List getConsumptionClause() {
        return this._getConsumptionClause();
    }
    ...
    public extensionTools.opl2.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(extensionTools.opl2.generated.impl.runtime.UnmarshallingContext context) {
        return new extensionTools.opl2.generated.impl.ConsumptionSentenceTypeImpl.Unmarshaller(context);
    }
    ...
    {
        int idx2 = 0;
        final int len2 = ((this._ConsumptionClause == null)? 0 :this._ConsumptionClause.size());
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (this._ConsumptionClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ConsumptionClause.get(idx2 ++)), "ConsumptionClause");
            } else {
                context.startElement("", "ConsumptionClause");
                int idx_6 = idx2;
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ConsumptionClause.get(idx_6 ++)), "ConsumptionClause");
                context.endNamespaceDecls();
                int idx_7 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ConsumptionClause.get(idx_7 ++)), "ConsumptionClause");
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) this._ConsumptionClause.get(idx2 ++)), "ConsumptionClause");
                context.endElement();
            }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._ConsumptionClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsAttributes(((com.sun.xml.bind.JAXBObject) this._ConsumptionClause.get(idx2 ++)), "ConsumptionClause");
            } else {
                idx2 += 1;
            }
        }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx2 != len2) {
            if (this._ConsumptionClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsURIs(((com.sun.xml.bind.JAXBObject) this._ConsumptionClause.get(idx2 ++)), "ConsumptionClause");
            } else {
                idx2 += 1;
            }
        }
    ...
    public java.lang.Class getPrimaryInterface() {
        return (extensionTools.opl2.generated.ConsumptionSentenceType.class);
    }
...
+"\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u0000/extensionTools.opl2.generated.Consump"
+"tionClauseq\u0000~\u0000Isq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\u0000ppsq\u0000~\u0000\tpp\u0000sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'"
+"psq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000Dq\u0000~\u0000Fq\u0000~\u00005sq\u0000~\u0000/t\u00003extensionTools.opl2.gen"
+"erated.ConsumptionClauseTypeq\u0000~\u0000Isq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000"
+"~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0011ConsumptionClauseq\u0000~\u00009sq\u0000~\u0000\"ppsq\u0000~\u0000;q\u0000~\u0000\'ps"
+"q\u0000~\u0000\tq\u0000~\u0000\'p\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u0011sq\u0000~\u0000\"ppsq\u0000~\u0000$q\u0000~\u0000\'pq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005"
+"sq\u0000~\u0000/t\u0000\tPathLabelq\u0000~\u00009q\u0000~\u00005sr\u0000\"com.sun.msv.grammar.Expressi"
...
+"q\u0000~\u0000Rq\u0000~\u0000Yq\u0000~\u0000mq\u0000~\u0000uq\u0000~\u0000rq\u0000~\u0000\u0005q\u0000~\u0000\u0006q\u0000~\u0000qq\u0000~\u0000Kq\u0000~\u0000fq\u0000~\u0000:q\u0000~\u0000\r"
+"q\u0000~\u0000Xq\u0000~\u0000\u0007q\u0000~\u0000tq\u0000~\u0000\bq\u0000~\u0000=q\u0000~\u0000]q\u0000~\u0000Aq\u0000~\u0000Nq\u0000~\u0000aq\u0000~\u0000iq\u0000~\u0000@q\u0000~\u0000M"
+"q\u0000~\u0000`q\u0000~\u0000hx"));
        }
        ...
        extends extensionTools.opl2.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return extensionTools.opl2.generated.impl.ConsumptionSentenceTypeImpl.this;
        }
                ...
                switch (this.state) {
                    case  3 :
                        if (("Role" == ___local)&&("" == ___uri)) {
                            ConsumptionSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.RoleImpl.class), 6, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("Role" == ___local)&&("" == ___uri)) {
                    ...
                    case  11 :
                        ...
                        break;
                    case  10 :
                        if (("ConsumptionClause" == ___local)&&("" == ___uri)) {
                            ConsumptionSentenceTypeImpl.this._getConsumptionClause().add(((extensionTools.opl2.generated.impl.ConsumptionClauseImpl) this.spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ConsumptionClauseImpl.class), 10, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        if (("ConsumptionClause" == ___local)&&("" == ___uri)) {
                            this.context.pushAttributes(__atts, false);
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (this.state) {
                    ...
                    case  11 :
                        if (("logicalRelation" == ___local)&&("" == ___uri)) {
                            ConsumptionSentenceTypeImpl.this._getConsumptionClause().add(((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl.class), 12, ___uri, ___local, ___qname)));
                            return ;
                        }
                    ...
                    case  4 :
                        if (("Library" == ___local)&&("" == ___uri)) {
                            ConsumptionSentenceTypeImpl.this._getRole().add(((extensionTools.opl2.generated.impl.RoleTypeImpl) this.spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 5, ___uri, ___local, ___qname)));
                            return ;
                        }
        ...
        {
            try {
                ConsumptionSentenceTypeImpl.this._getPathLabel().add(value);
            } catch (java.lang.Exception e) {
        ...
        {
            try {
                ConsumptionSentenceTypeImpl.this._LogicalRelation = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
        ...
        {
            try {
                ConsumptionSentenceTypeImpl.this._ProcessName = value;
            } catch (java.lang.Exception e) {
                this.handleParseConversionException(e);
            }
        }
