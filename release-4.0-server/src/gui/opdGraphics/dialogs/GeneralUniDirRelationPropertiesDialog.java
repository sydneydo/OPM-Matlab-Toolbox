...
//	private GeneralRelationEntry relationEntry;
	...
	public GeneralUniDirRelationPropertiesDialog(OpmUniDirectionalRelation relation, OpdKey key, OpdProject myProject)
	{
		...
		this.myEntry = (GeneralRelationEntry)this.myStructure.getEntry(this.uniDirGeneralRelation.getId());
		this.myInstance = (GeneralRelationInstance)this.myEntry.getInstance(key);

		long sId, dId;

		sId = myInstance.getSourceInstance().getEntry().getId() ; //this.uniDirGeneralRelation.getSourceId();
		dId = myInstance.getDestinationInstance().getEntry().getId() ; //this.uniDirGeneralRelation.getDestinationId();

		this.sourceName = this.myStructure.getEntry(sId).getLogicalEntity().getName().replace('\n',' ');
		this.destinationName = this.myStructure.getEntry(dId).getLogicalEntity().getName().replace('\n',' ');
...
//		applyButton.setEnabled(false);
    ...
    {
        this.relationMeaning.requestFocus();
    }
...
//			description.setEditable(false);
			...
			this.relationMeaning = new JTextField(this.uniDirGeneralRelation.getForwardRelationMeaning());
			...
			if (this.uniDirGeneralRelation.getSourceCardinality().compareTo("1") == 0)
			{
				this.sourceCardinality.setSelectedItem("1");
			}
			else
						{
						  if (this.uniDirGeneralRelation.getSourceCardinality().compareTo("m") == 0)
						  {
				 ...
				 this.customSourceCardinality.setText(this.uniDirGeneralRelation.getSourceCardinality());
						  }
						}
			...
			if ( this.uniDirGeneralRelation.getDestinationCardinality().compareTo("1") == 0)
						{
				this.destinationCardinality.setSelectedItem("1");
			}
			else
						{
							if (this.uniDirGeneralRelation.getDestinationCardinality().compareTo("m") == 0)
							{
				...
				this.customDestinationCardinality.setText(this.uniDirGeneralRelation.getDestinationCardinality());
				}
						}


			this.sourceCardinality.addActionListener(new SourceCardinalityListener());
			this.destinationCardinality.addActionListener(new DestinationCardinalityListener());
		}
				catch(Exception e)
		{
...
//		tab.add(p1);
		...
		// relation meaning
		this.p1 = new JPanel();
		this.p1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "  Tag  "));
		this.p1.setLayout(new BoxLayout(this.p1, BoxLayout.X_AXIS));
		this.p1.add(this.relationMeaning);
		tab.add(this.p1);
		...
		this.p2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "  Source  "));
		...
		this.p2 = new JPanel();
		this.p2.setLayout(new GridLayout(2, 3, 3, 0));
		this.p2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "  Destination  "));
		...
		this.customDestinationCardinality.setBorder(BorderFactory.createEtchedBorder());
	...
	private boolean _updateRelationData()
	{
		...
		if((String.valueOf(this.sourceCardinality.getSelectedItem())).compareTo("custom") == 0)
		{
			if(GraphicsUtils.checkCustomCardinalityLegality(this.customSourceCardinality.getText()))
			{
				this.uniDirGeneralRelation.setSourceCardinality(this.customSourceCardinality.getText());
			}
			else
			{
				this.customSourceCardinality.setSelectionStart(0);
				this.customSourceCardinality.setSelectionEnd(this.customSourceCardinality.getText().length());
		...
		{
			if((String.valueOf(this.sourceCardinality.getSelectedItem())).compareTo("many") == 0)
			{
				this.uniDirGeneralRelation.setSourceCardinality("m");
			}
			else
			{
				this.uniDirGeneralRelation.setSourceCardinality("1");
			}
		}


		if((String.valueOf(this.destinationCardinality.getSelectedItem())).compareTo("custom") == 0)
		{
//			try
//			{
...
//				return false;
//			}
			if(GraphicsUtils.checkCustomCardinalityLegality(this.customDestinationCardinality.getText()))
			{
				this.uniDirGeneralRelation.setDestinationCardinality(this.customDestinationCardinality.getText());
			}
			else
			{
				JOptionPane.showMessageDialog(null, "Custom cardinality should be of the form min..max or v1, v2, v3 or combination of them.", "Opcat 2 - Error" ,JOptionPane.ERROR_MESSAGE);
		...
		{
			if ((String.valueOf(this.destinationCardinality.getSelectedItem())).compareTo("many") == 0)
			{
				this.uniDirGeneralRelation.setDestinationCardinality("m");
			}
			else
			{
				this.uniDirGeneralRelation.setDestinationCardinality("1");
			}
		}

		this.uniDirGeneralRelation.setForwardRelationMeaning(this.relationMeaning.getText());
		this.uniDirGeneralRelation.setEnviromental(this.environmental.isSelected());
	...
	class BgColorButtonListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			Color newColor = JColorChooser.showDialog(GeneralUniDirRelationPropertiesDialog.this,
					...
					GeneralUniDirRelationPropertiesDialog.this.bgColor.getBackground());
			if(newColor != null) {
	...
	class TextColorButtonListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			Color newColor = JColorChooser.showDialog(
					...
					"Choose Text Color",
					GeneralUniDirRelationPropertiesDialog.this.textColor.getBackground());
			if(newColor != null) {
	...
	class BorderColorButtonListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			Color newColor = JColorChooser.showDialog(
					GeneralUniDirRelationPropertiesDialog.this,
					"Choose Border Color",
					GeneralUniDirRelationPropertiesDialog.this.borderColor.getBackground());
			if(newColor != null) {
	...
	class SourceCardinalityListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if (((String.valueOf(GeneralUniDirRelationPropertiesDialog.this.sourceCardinality.getSelectedItem())).compareTo("custom")) == 0)
			{
				GeneralUniDirRelationPropertiesDialog.this.customSourceCardinality.setEditable(true);
				GeneralUniDirRelationPropertiesDialog.this.customSourceCardinality.requestFocus();
			}
			else
			{
				GeneralUniDirRelationPropertiesDialog.this.customSourceCardinality.setEditable(false);
				GeneralUniDirRelationPropertiesDialog.this.customSourceCardinality.setText("");
			}
			return;
		}
	}
	...
	class DestinationCardinalityListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			if (((String.valueOf(GeneralUniDirRelationPropertiesDialog.this.destinationCardinality.getSelectedItem())).compareTo("custom")) == 0)
			{
				GeneralUniDirRelationPropertiesDialog.this.customDestinationCardinality.setEditable(true);
				GeneralUniDirRelationPropertiesDialog.this.customDestinationCardinality.requestFocus();
			}
			else
			{
				GeneralUniDirRelationPropertiesDialog.this.customDestinationCardinality.setEditable(false);
				GeneralUniDirRelationPropertiesDialog.this.customDestinationCardinality.setText("");
			}
			return;
		}
	}
