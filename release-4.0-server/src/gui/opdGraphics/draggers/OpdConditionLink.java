...
/**
 *  Graphic represenrartion of OPM Condition Link.<br>
 *  <p>
 ...
 *  <p>Condition link consist of <code>OpdConditionLink</code> on one edge, <a href = "TransparentAroundDragger.html"><code>TransparentAroundDragger</code></a>
 *  on second edge and <a href = "OpdSimpleLine.html><code>OpdSimpleLine</code></a> connecting them.
 */
public class OpdConditionLink extends OpdLink
{
	 ...
	 *  Constructs OpdConditionLink (subclass of <a href = "AroundDragger.html><code>AroundDragger</code></a>).
	 ...
	 *  @param <code>pLink OpdConditionLink</code>, logical representation of the link, for more information see <code>opmEntities.OpdConditionLink</code>.
	 */

	public OpdConditionLink(Connectable pEdge, RelativeConnectionPoint pPoint, OpmConditionLink pLink,
	...
	public void  paintComponent(Graphics g)
	{
		...
		int stringX = (int)Math.round(center.getX() - currentMetrics.stringWidth("c")/2);
		...
		g2.drawString("c",stringX,stringY);
	...
	{
		 LinkPropertiesDialog ld = new LinkPropertiesDialog(this.myLink, new OpdKey(this.getOpdId(), this.getEntityInOpdId()), this.myProject,"Condition");
		 ld.setVisible(true);
	}
}
