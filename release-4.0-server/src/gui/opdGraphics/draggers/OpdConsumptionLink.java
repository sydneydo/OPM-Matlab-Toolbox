 ...
 */
public class OpdConsumptionLink extends ArrowLink
{
	/**
	 * 
	 */
	 ...
	 */
	public OpdConsumptionLink(Connectable pEdge, RelativeConnectionPoint pPoint, OpmTransformationLink pLink,
	...
	{
		LinkPropertiesDialog ld = new LinkPropertiesDialog(this.myLink, new OpdKey(this.getOpdId(), this.getEntityInOpdId()), this.myProject, "Consumption");
		ld.setVisible(true);
	}
