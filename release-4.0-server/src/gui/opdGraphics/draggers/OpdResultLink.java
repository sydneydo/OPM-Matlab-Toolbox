 ...
 */
public class OpdResultLink extends ArrowLink
{
	/**
	 * 
	 */
	 ...
	 */
	public OpdResultLink(Connectable pEdge, RelativeConnectionPoint pPoint, OpmTransformationLink pLink,
	...
	{
		LinkPropertiesDialog ld = new LinkPropertiesDialog(this.myLink, new OpdKey(this.getOpdId(), this.getEntityInOpdId()), this.myProject, "Result");
		ld.setVisible(true);
	}
