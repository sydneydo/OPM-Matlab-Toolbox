...
public class VerticalGridLayout implements LayoutManager, java.io.Serializable {
    ...
    /**
         ...
         * between columns. They can be changed at any time. This should be a
    ...
    /**
         ...
         * between rows. They can be changed at any time. This should be a non
         * negative integer.
         * 
         * @serial
         * @see #getVgap()
    ...
    /**
         * This is the number of rows specified for the grid. The number of rows
         * can be changed at any time. This should be a non negative integer,
         * where '0' means 'any number' meaning that the number of Rows in that
    ...
    /**
         ...
         * integer, where '0' means 'any number' meaning that the number of
         * Columns in that dimension depends on the other dimension.
         * 
         * @serial
         * @see #getColumns()
         * @see #setColumns(int)
    ...
    /**
         * Creates a grid layout with a default of one column per component, in
         * a single row.
         * 
         * @since JDK1.1
         */
    ...
    /**
         ...
         * 
         * @param rows
         *                the rows, with the value zero meaning any number of
         *                rows.
         * @param cols
    ...
    /**
         ...
         * specified values. Horizontal gaps are placed at the left and right
         * edges, and between each of the columns. Vertical gaps are placed at
         * the top and bottom edges, and between each of the rows.
         * <p>
         * One, but not both, of <code>rows</code> and <code>cols</code> can
         * be zero, which means that any number of objects can be placed in a
         * row or in a column.
    ...
    /**
         ...
         * Setting the number of columns has no affect on the layout if the
         * number of rows specified by a constructor or by the <tt>setRows</tt>
         * method is non-zero. In that case, the number of columns displayed in
         * the layout is determined by the total number of components and the
    ...
    /**
         ...
         * of any of the components in the container times the number of
         * columns, plus the horizontal padding times the number of columns plus
    ...
    /**
         ...
         * any of the components in the container times the number of rows, plus
         * the vertical padding times the number of rows plus one, plus the top
         * and bottom insets of the target container.
         * 
         * @param parent
         *                the container in which to do the layout
    ...
    /**
         ...
         * <p>
         * This method reshapes the components in the specified target container
         * in order to satisfy the constraints of the
         * <code>VerticalGridLayout</code> object.
         * <p>
         * The grid layout manager determines the size of individual components
         * by dividing the free space in the container into equal-sized portions
         * according to the number of rows and columns in the layout. The
         * container's free space equals the container's size minus any insets
         * and any specified horizontal or vertical gap. All components in a
         * grid layout are given the same size.
         * 
         * @param parent
         *                the container in which to do the layout
