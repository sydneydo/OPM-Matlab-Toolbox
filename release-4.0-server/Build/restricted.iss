...
[Setup]
AppName=OPCAT
AppVerName=OPCAT version 4.0
AppCopyright=Copyright � 1999-2008 Opcat, Inc.

OutputBaseFilename =restricted
DefaultDirName={pf}\Opcat
DefaultGroupName=Opcat
UninstallDisplayIcon={app}\Opcat.jar
Uninstallable=yes
LicenseFile=RestrictedVersionEULA.rtf
AlwaysRestart=true
...
;Source: images\winimages\*.gif; DestDir: {app}\images\winimages
;Source: images\alButtons\*.gif; DestDir: {app}\images\alButtons
...
Source: salicense.dat; DestDir: {app}; Flags: ignoreversion
Source: Dataform.xlt; DestDir: {app}; Flags: ignoreversion overwritereadonly; Attribs: readonly; Tasks: 
...
Name: {app}\icons; Tasks: ; Flags: uninsneveruninstall
